module.exports = {
  ...
  {
    header: `Only up from here`, text: `I have found my love for programming very naturally when serving up database queries. As well as anything in between that and launching projects to a functional state. I currently specialize in full stack development with JavaScript integrations here in NYC.`, img: [`Present.jpg`]
  }
  ],
  projects: [{
